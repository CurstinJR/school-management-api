...
class EmployeeAddressServiceImplTest {
    ...
    @Test
    void findById() {
        given(employeeAddressRepository.findEmployeeAddressByStaffId("2")).willReturn(Optional.of(employeeAddress2));
        EmployeeAddress saveEmployeeAddress = employeeAddressService
                .findEmployeeAddressByStaffId(employeeAddress2.getStaffId()).orElseThrow();
        assertNotNull(saveEmployeeAddress);
        assertAll(
                () -> assertEquals("2", saveEmployeeAddress.getStaffId())
        );
    }
    ...
    void deleteById() {
        String id = "1";
        employeeAddressService.deleteById(employeeAddress1.getStaffId());
